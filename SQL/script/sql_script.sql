...
-- ------------------------------------------------------------
-- TRIGGERS: Solo protección de tablas inmutables
-- Se mantienen en BD como ultima linea de defensa
-- ante acceso directo desde herramientas externas
-- ------------------------------------------------------------
...
-- Bodega Central Medellin (id: 1)
(1,  1,  20,  5,   50,   'ACTIVO', NOW()),  -- id_inventario: 1
(2,  1,  100, 20,  300,  'ACTIVO', NOW()),  -- id_inventario: 2
(3,  1,  15,  5,   40,   'ACTIVO', NOW()),  -- id_inventario: 3
(4,  1,  500, 100, 1000, 'ACTIVO', NOW()),  -- id_inventario: 4
(5,  1,  200, 50,  500,  'ACTIVO', NOW()),  -- id_inventario: 5
(9,  1,  80,  20,  200,  'ACTIVO', NOW()),  -- id_inventario: 6
(10, 1,  60,  15,  150,  'ACTIVO', NOW()),  -- id_inventario: 7
-- Bodega Norte Bello (id: 2)
(5,  2,  150, 30,  400,  'ACTIVO', NOW()),  -- id_inventario: 8
(6,  2,  90,  20,  250,  'ACTIVO', NOW()),  -- id_inventario: 9
(7,  2,  70,  10,  200,  'ACTIVO', NOW()),  -- id_inventario: 10
(8,  2,  300, 50,  800,  'ACTIVO', NOW()),  -- id_inventario: 11
-- Bodega Bogota Centro (id: 3)
(1,  3,  10,  3,   30,   'ACTIVO', NOW()),  -- id_inventario: 12
(3,  3,  8,   2,   20,   'ACTIVO', NOW()),  -- id_inventario: 13
(7,  3,  50,  10,  150,  'ACTIVO', NOW()),  -- id_inventario: 14
(9,  3,  40,  10,  100,  'ACTIVO', NOW()),  -- id_inventario: 15
-- Bodega Cali Sur (id: 4)
(2,  4,  60,  10,  200,  'ACTIVO', NOW()),  -- id_inventario: 16
(5,  4,  100, 25,  300,  'ACTIVO', NOW()),  -- id_inventario: 17
(6,  4,  55,  10,  150,  'ACTIVO', NOW()),  -- id_inventario: 18
(10, 4,  30,  5,   80,   'ACTIVO', NOW());  -- id_inventario: 19


-- ENTRADAS (inventario_origen_id = NULL)
...
-- TRASLADOS (origen y destino requeridos)
...
-- SALIDAS (inventario_destino_id = NULL)
...
-- AJUSTES (inventario_destino_id = NULL)
